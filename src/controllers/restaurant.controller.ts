...
restaurantConroller.processSignup =  async  (
  req: AdminRequest, 
  res: Response
) => {
  try {
...
restaurantConroller.processLogin = async (
  req: AdminRequest,
   res: Response
  ) => {
  try{
...
restaurantConroller.checkAuthSession= async (
  req: AdminRequest,
   res: Response
  ) => {
  try {
...
restaurantConroller.getUsers = async (req: Request, res: Response) => {
  try{
...
restaurantConroller.updateChosenUser =  async (req: Request, res: Response) => {
  try{
